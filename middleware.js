...
const EXPEDITION_META = {
  'olympus':              { title: 'HighAir Expeditions | טרק לפסגת האולימפוס',           img: '/images/og/olympus.jpg',           description: 'טרק הר האולימפוס - הר האלים של יוון, 2,918 מטר. 6 ימים, מסלול דרך יערות פריוניה, פסגת מיטיקאס ויום קניונינג בנהר האורליאס. קבוצה קטנה.' },
  ...
  'ethiopia':             { title: 'HighAir Expeditions | טרק סימיאן ומדבר דנקיל',        img: '/images/og/ethiopia.jpg',          description: 'טרק הרי סימיאן ומדבר דנקיל באתיופיה - 4,550 מטר. 12 ימים, אגם לבה פעיל בארטה אלה, שקע דאלול הצבעוני, כנסיות חצובות בסלע וג׳לדות בסימיאן. ניגוד קיצוני בין מדבר להרים.' },
  'kazbek':               { title: 'HighAir Expeditions | טיפוס לקזבק',                   img: '/images/og/kazbek.jpg',            description: 'טיפוס לקזבק - הר געש כבוי בקווקז, 5,054 מטר. 8 ימים בגאורגיה, מסלול דרך קרחון גרגטי ובייס קמפ ב-3,650 מטר. מדריכי IFMGA, קבוצה קטנה.' },
  'manaslu':              { title: 'HighAir Expeditions | טרק סובב מנסלו',                 img: '/images/og/manaslu.jpg',           description: 'טרק סובב מנסלו - 5,106 מטר בנפאל. 16 ימים, לולאה מסביב להר השמיני בגובהו בעולם דרך כפרי טיבט ומעבר לרקיה לה. פחות תיירים, נוף בלתי מוכר.' },
  'everest-base-camp':    { title: 'HighAir Expeditions | טרק אוורסט בייס קמפ',           img: '/images/og/everest-base-camp.jpg', description: 'טרק אוורסט בייס קמפ ואגמי גוקיו - 5,364 מטר בנפאל. 19 ימים, בייס קמפ, קאלה פטאר, מעבר צ׳ו לה ואגמי גוקיו במסלול אחד. קבוצה עד 10 איש.' },
  'annapurna':            { title: 'HighAir Expeditions | טרק סובב אנאפורנה',              img: '/images/og/annapurna.jpg',         description: 'טרק סובב אנאפורנה - 5,416 מטר בנפאל. 16 ימים, לולאה מלאה סביב אנאפורנה דרך כפרי גורקה, אגם טיליצ׳ו ומעבר תורונג לה. ירידה של 1,600 מטר בצד השני.' },
  'elbrus':               { title: 'HighAir Expeditions | טיפוס לאלברוס',                 img: '/images/og/elbrus.jpg',            description: 'טיפוס לאלברוס - ההר הגבוה באירופה, 5,642 מטר. 8 ימים ברוסיה, אחת מ-7 הפסגות. מסלול דרומי עם רכבל עד 3,850 מטר, לינה בבקתות ויום פסגה של 10-14 שעות.' },
  'kilimanjaro':          { title: 'HighAir Expeditions | טיפוס לקילימנג׳רו',             img: '/images/og/kilimanjaro.jpg',       description: 'טיפוס לקילימנג׳רו - הפסגה הגבוהה באפריקה, 5,895 מטר. מסלול מאצ׳מה 7 ימים, 5 אזורי אקלים, יציאה לפסגה בחצות. שיעור הצלחה 94%. ספארי אופציונלי.' },
  'kilimanjaro-kosher':   { title: 'HighAir Expeditions | קילימנג׳רו לשומרי מסורת',       img: '/images/og/kilimanjaro-kosher.jpg', description: 'טיפוס לקילימנג׳רו - הפסגה הגבוהה באפריקה, 5,895 מטר - לשומרי מסורת. 10 ימים כולל שבת בארושה עם חב״ד, אוכל כשר מהדרין לאורך כל הטיפוס. שיעור הצלחה 94%.' },
  'lobuche-peak':         { title: 'HighAir Expeditions | טיפוס ללובוצ׳ה פיק',           img: '/images/og/lobuche-peak.jpg',      description: 'טיפוס ללובוצ׳ה פיק - 6,119 מטר בנפאל. 19 ימים, פסגה ממול קרחון קומבו עם נוף ישיר על אוורסט. כולל בייס קמפ אוורסט וקאלה פטאר לפני יום הפסגה.' },
  'island-peak':          { title: 'HighAir Expeditions | טיפוס לאיילנד פיק',             img: '/images/og/island-peak.jpg',       description: 'טיפוס לאיילנד פיק - 6,189 מטר בנפאל. 20 ימים, פסגה טכנית עם נוף על אוורסט, להוצה, מקאלו, צ׳ו אויו ואמה דבלאם בבת-אחת. כולל בייס קמפ אוורסט מלא.' },
  'mera-peak':            { title: 'HighAir Expeditions | טיפוס למרה פיק',                img: '/images/og/mera-peak.jpg',         description: 'טיפוס למרה פיק - הפסגה הגבוהה לטרקינג בנפאל, 6,476 מטר. 19 ימים, מסלול דרך עמק הינקו, ללא טיפוס טכני. נוף על 5 שמיניות מהפסגה.' },
  'aconcagua':            { title: 'HighAir Expeditions | טיפוס לאקונקגואה',              img: '/images/og/aconcagua.jpg',         description: 'טיפוס לאקונקגואה - הפסגה הגבוהה בחצי הכדור המערבי, 6,962 מטר. 20 ימים בארגנטינה, אחת מ-7 הפסגות. שלושה מחנות גובה, פרדות עד בייס קמפ. שיעור הצלחה 75%.' },
  'lenin-peak':           { title: 'HighAir Expeditions | טיפוס ללנין פיק',              img: '/images/og/lenin-peak.jpg',        description: 'טיפוס ללנין פיק - ההר הנגיש מעל 7,000 מטר, 7,134 מטר בקירגיזסטן. 20 ימים, שלושה מחנות גובה, בייס קמפ עם יורטות. נדרש ניסיון מעל 5,500 מטר.' },
};

/* ── Israel trails ── */
const ISRAEL_META = {
  'hermon':           { title: 'HighAir Expeditions | טרק לפסגת החרמון',         img: '/images/og/hermon.jpg',   description: 'טרק לפסגת החרמון - הפסגה הגבוהה בישראל, 2,040 מטר. 2 ימים כולל לינה, עלייה של 1,040 מטר דרך מעלה גולני, ערב גיבוש עם ארוחה על האש וארוחת צהריים דרוזית.' },
  ...
  'avnat':            { title: 'HighAir Expeditions | טרק מצוקי אבנת',            img: null,                      description: 'טרק מצוקי אבנת בנגב הגבוה - 1,000 מטר, יום אחד מאתגר. שרשרת מצוקי גיר דרמטיים עם תצפיות פנורמיות למישורי הנגב. מדריך מוסמך, ארוחת צהריים כלולה.' },
  ...
  'meron':            { title: 'HighAir Expeditions | טרק הר מירון',              img: null,                      description: 'טרק הר מירון - הפסגה הגבוהה בגליל, 1,208 מטר. יום אחד, יערות אלה עתיקים ונוף פנורמי לכנרת, לבנון וחרמון. מדריך מוסמך, ארוחת צהריים כלולה.' },
};
