...
const EXPEDITION_META = {
  ...
  'ethiopia':             { title: 'HighAir Expeditions | טרק סימיאן ומדבר דנקיל',        img: '/images/og/ethiopia.jpg',          description: 'טרק הרי סימיאן ומדבר דנקיל באתיופיה - 4,550 מטר. 11 ימים, אגם לבה פעיל בארטה אלה, שקע דאלול הצבעוני וג׳לדות בסימיאן. ניגוד קיצוני בין מדבר להרים.' },
