...
const getWhyCards = (exp, isRtl) => {
  ...
  if (exp?.type === 'Safari') {
    return isRtl ? [
      ...
      { icon: '🕶️', title: '15% הנחה על משקפי ספורט בחנות ״Swift Optics״', desc: '' },
      ...
      { icon: '🥤', title: '25% הנחה על תוספי מזון בחנות ״פרו ראנר״', desc: '' },
      ...
      { icon: '🕶️', title: '15% discount on sport glasses at Swift Optics store', desc: '' },
      ...
      { icon: '🥤', title: '25% discount on nutrition supplements at Pro Runner store', desc: '' },
