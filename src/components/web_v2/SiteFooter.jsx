    ...
    <footer style={{
      ...
      <div style={{ maxWidth: '1280px', margin: '0 auto' }}>
        ...
        <div style={{
          ...
          {/* ── Col: טרקים בעולם — mobile: right top ── */}
          ...
          {/* ── Col: טיפוסים בעולם — mobile: left top ── */}
          ...
          {/* ── Col: טרקים בארץ — mobile: right bottom ── */}
          ...
          {/* ── Col: מידע — mobile: left bottom ── */}
          <div style={{ order: isMobile ? 4 : 4 }}>
          ...
          {/* Logo + desc + social — mobile: full-width last row ── */}
          <div style={{
            order: isMobile ? 5 : 0,
            ...
            <p style={{
              ...
              color: '#6B6B8A', margin: '0 0 24px', lineHeight: 1.7,
              maxWidth: '240px', textAlign: isMobile ? 'center' : 'right',
            }}>
