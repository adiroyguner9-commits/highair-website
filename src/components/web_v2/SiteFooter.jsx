...
function SocialIcons({ size = 36, justify = 'flex-start' }) {
  return (
    <div style={{ display: 'flex', gap: '10px', flexWrap: 'wrap', justifyContent: justify }}>
      {SOCIALS.map(s => (
      ...
      <footer style={{ background: '#FFFFFF', padding: '48px 5% 28px', boxSizing: 'border-box', direction: 'rtl', borderTop: '1px solid #E2E0F0' }}>
        <div style={{ maxWidth: '1280px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', marginBottom: '52px' }}>
            ...
            <p style={{ fontFamily: "'Ploni', sans-serif", fontSize: FS.sm, fontWeight: 300, color: '#6B6B8A', margin: '0 0 24px', lineHeight: 1.7, maxWidth: '240px', textAlign: 'center' }}>
      ...
      <div style={{ maxWidth: '1280px', margin: '0 auto' }}>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start' }}>
            ...
            <p style={{ fontFamily: "'Ploni', sans-serif", fontSize: FS.sm, fontWeight: 300, color: '#6B6B8A', margin: '0 0 24px', lineHeight: 1.7, maxWidth: '240px', textAlign: 'right' }}>
              משלחות טיפוס הרים וטרקים בעולם ובישראל - בשילוב תרומה לחולי סרטן בכל מסע.
            </p>
