...
export const POSTS = [
   ...
   * ═══════════════════════════════════════════════════════════════════ */
  {
    ...
    /* ── Hebrew content ── */
    content: [
      { type: 'text', value: 'בבוקר ה-27 במאי 2026 עמדה קריסטין הרילה על פסגת האוורסט, 8,849 מטרים, הנקודה הגבוהה ביותר על פני כדור הארץ. עם ההעפלה הזו היא השלימה את "שלושת הכתרים", נופטסה, להוצה והאוורסט, שלוש הפסגות הגבוהות במסיב האוורסט, בעונת טיפוס אחת. רק ארבעה בני אדם בהיסטוריה עשו זאת לפניה, ואף אישה לא הייתה ביניהם.' },
