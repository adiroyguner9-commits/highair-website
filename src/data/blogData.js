...
export const POSTS = [
   ...
   * ═══════════════════════════════════════════════════════════════════ */
  {
    ...
    /* ── Hebrew content ── */
    content: [
      { type: 'text', value: 'בבוקר ה-27 במאי 2026 עמדה קריסטין הרילה על פסגת האוורסט, 8,849 מטרים, הנקודה הגבוהה ביותר על פני כדור הארץ. עם ההעפלה הזו היא השלימה את "שלושת הכתרים", נופטסה, להוצה והאוורסט, שלוש הפסגות הגבוהות באזור האוורסט, בעונת טיפוס אחת. רק ארבעה בני אדם בהיסטוריה עשו זאת לפניה, ואף אישה לא הייתה ביניהם.' },
      ...
      { type: 'image', src: '/images/blog/harila-nuptse-summit.jpg', alt: 'קריסטין הרילה בפסגת נופטסה עם דגל נורווגיה', caption: 'קריסטין הרילה בפסגת נופטסה, 17 במאי 2026. גובה 7,861 מטרים, ללא חמצן משלים' },
      ...
      { type: 'image', src: '/images/blog/harila-lhotse-summit.jpg', alt: 'קריסטין הרילה כורעת על פסגת להוצה עם דגל נורווגיה', caption: 'קריסטין הרילה בפסגת להוצה, 21 במאי 2026. גובה 8,516 מטרים' },
      ...
      { type: 'text', value: 'טיפוס בעונה אחת על שלוש הפסגות הגבוהות באזור האוורסט: נופטסה (7,861 מטרים), להוצה (8,516 מטרים) והאוורסט (8,848 מטרים). רק ארבעה אנשים בהיסטוריה השלימו את הרצף הזה.' },
