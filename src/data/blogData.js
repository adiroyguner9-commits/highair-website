...
export const POSTS = [
   ...
   * ═══════════════════════════════════════════════════════════════════ */
  {
    ...
    category: 'חדשות',
    categoryEn: 'News',
    img:             '/images/blog/nepal-gyirong-flood.webp',
   ...
   * ═══════════════════════════════════════════════════════════════════ */
  {
    ...
    imgCredit:       '',
    excerpt:  'המטפס האגדי נירמל "נימסדאי" פורג׳ה, גיבור הסרט "14 פסגות" ובעל שיא של 57 עליות לגובה 8,000 מ׳, נספה במפולת בברואד פיק יחד עם תשעה מטפסים נוספים.',
    ...
    content: [
      ...
      { type: 'text', value: 'בעולם טיפוס ההרים ישנן 14 פסגות שגובהן מעל 8,000 מ׳. לפני נימסדאי, השלמת כל 14 הפסגות לקחה למטפסים המהירים בעולם שנים, ולעיתים עשור שלם.' },
      ...
      { type: 'text', value: 'מאז השלמת "פרויקט אפשרי", נימסדאי לא הפסיק לטפס. הוא המשיך לצבור פסגות של 8,000 מ׳, ובכל פעם דחף מעט יותר את גבולות מה שנחשב אפשרי.' },
      { type: 'text', value: 'ב-21 ביולי 2026, תשעה ימים בלבד לפני האסון, העפיל לפסגת גשרברום השני, בגובה 8,035 מ׳. זו הייתה העלייה ה-57 שלו לפסגה מעל 8,000 מ׳, והוא ביצע אותה ללא חמצן משלים, בפעם ה-29 שלו בלי חמצן.' },
      { type: 'callout', title: '✦ שיא כל הזמנים', value: '57 עליות לפסגות מעל 8,000 מ׳, יותר מכל מטפס אחר בהיסטוריה. 29 מהן בוצעו ללא חמצן משלים.' },
      { type: 'text', value: 'עם המספרים האלה הפך נימסדאי למטפס עם הכי הרבה עליות לפסגות של 8,000 מ׳ אי פעם. ואז הוא החליט להמשיך עוד קצת.' },

      { type: 'section', value: 'המשימה האחרונה שנקטעה' },
      { type: 'text', value: 'ב-2026 הכריז נימסדאי על פרויקט חדש: לטפס על כל 14 פסגות ה-8,000 מ׳ שלוש פעמים, ובמקביל להשלים שלוש פעמים גם את אתגר שבע הפסגות, שבע הפסגות הגבוהות בכל יבשת. הכל ללא חמצן משלים.' },
      { type: 'text', value: 'בפוסט שהעלה לרשת לפני היציאה לברואד פיק, הוא כתב:' },
      { type: 'text', value: '"זו לא הייתה התוכנית המקורית. במקור התכוונתי לטפס רק על גשרברום השני. אבל ממש לפני היציאה לפקיסטן ספרתי שוב את פסגות ה-8,000 שלי, וזה פגע בי: אם אני מטפס גם על ברואד פיק בזמן שאני כאן, נשאר לי רק צ׳ו אויו כדי להיות האדם הראשון בהיסטוריה שטיפס פעמיים על כל 14 פסגות ה-8,000 מ׳. בלי חמצן."' },
      { type: 'text', value: 'המסע שנועד להשלים את מחצית הפרויקט השאפתני הזה הסתיים בטרגדיה.' },

      { type: 'section', value: 'מה קרה בברואד פיק' },
      { type: 'text', value: 'ברואד פיק, בגובה 8,047 מ׳, הוא הפסגה ה-12 הגבוהה בעולם. הוא ניצב ברכס הקרקורם שבפקיסטן, סמוך להר K2, ונחשב לאחת מפסגות ה-8,000 מ׳ הפחות מאתגרות טכנית. פחות מאתגר, אבל רחוק מלהיות בטוח.' },
      { type: 'text', value: 'בשבועות שקדמו לאסון ירדו שלגים כבדים על רכס הקרקורם. משלחות אחרות שהיו בבייס קמפ בחרו להתפנות ולחזור הביתה בגלל הסיכון. מטפסים שעזבו את ההר תיארו שברואד פיק "שינה את מזג הרוח שלו" באופן דרמטי. הצוות של נימסדאי בחר להישאר.' },
      { type: 'text', value: 'ב-30 ביולי, בשעות הבוקר, מפולת ענקית נסחפה במורד הגלישה המרכזית של ההר וסחפה את כל עשרת חברי המשלחת שנעו בין המחנה השני לשלישי, בגובה של כ-6,500 מ׳. הקשר איתם נותק באחת.' },
      ...
      { type: 'section', value: 'המפגש בבייס קמפ של מנסלו' },
      { type: 'text', value: 'עבור צוות HighAir, האסון הזה נוגע קרוב מהרגיל. בספטמבר 2025, כשחן שקד שהה בבייס קמפ של הר מנסלו כחלק ממשלחת ישראלית, הוא נפגש עם נימסדאי עצמו.' },
      { type: 'text', value: 'התמונה של השניים בבייס קמפ, פחות משנה לפני האסון, הפכה בין רגע מזיכרון של מפגש מקצועי לחלק ממורשת של אגדה שאבדה. חן זוכר אדם שהיה בדיוק כמו שקיווה שיהיה: חם, נוכח, ומלא באנרגיה שהדביקה את כל מי שעמד לידו.' },
      ...
      { type: 'list', items: [
        ...
        'מחלת גובה: מעל 3,000 מ׳ הסיכון עולה משמעותית. פסגות של 8,000 מ׳ נמצאות ב"אזור המוות", גובה שבו הגוף האנושי אינו מסוגל להתאושש.',
      ...
      { type: 'text', value: 'מטפס נפאלי-בריטי שנחשב לאחד מגדולי המטפסים בהיסטוריה. הוא היה הראשון בעולם שהעפיל לכל 14 הפסגות מעל 8,000 מ׳ בפחות מחצי שנה, שיא שעומד בעינו עד היום.' },
      ...
      { type: 'text', value: '⁦14 Peaks: Nothing Is Impossible⁩ הוא סרט תיעודי של נטפליקס מ-2021 שמתעד את "פרויקט אפשרי", העלייה של נימסדאי לכל 14 הפסגות של 8,000 מ׳ בפחות משבעה חודשים.' },
      { type: 'heading', value: 'איפה נמצא הר ברואד פיק?' },
      { type: 'text', value: 'ברואד פיק, בגובה 8,047 מ׳, נמצא ברכס הקרקורם בגבול פקיסטן וסין, סמוך להר K2. הוא הפסגה ה-12 הגבוהה בעולם.' },
  ...
  /* {
    ...
    content: [
      { type: 'text', value: 'בשעה חמש לפנות בוקר, בטמפרטורה של מינוס 12 מעלות, עומדים מרבית מטפסי קילימנג\'רו בנקודה הנקראת "סטלה פוינט", גובה 5,739 מ׳. מאחוריהם שש שעות של עלייה בחושך. לפניהם עוד ארבעים דקות עד פסגת אוהורו, הנקודה הגבוהה ביותר באפריקה. ברגע הזה, כמעט כל אחד שואל את עצמו שאלה אחת: מה בדיוק הוא עשה לעצמו.' },
      { type: 'text', value: 'קילימנג\'רו, 5,895 מ׳, הוא ההר הגבוה ביותר באפריקה ואחד מ"שבע הפסגות", שבעת ההרים הגבוהים ביותר בכל אחת משבע היבשות. הוא אינו דורש כישורי טיפוס טכניים, אינו דורש חמצן משלים, ואפשר לטפס עליו ברגל, ללא ציוד מיוחד. ובכל זאת, נתוני הצלחה רשמיים מראים שכ-45 אחוז מהמטפסים אינם מגיעים לפסגה. הדיסוננס הזה בין "כל אחד יכול" לבין "לא כולם מצליחים" הוא מה שכדאי להבין לעומק לפני שמחליטים.' },
      ...
      { type: 'text', value: 'אבל ההגדרה הטכנית מפספסת משהו מהותי. "הליכה בעלייה" בגובה 5,800 מ׳ נראית אחרת לגמרי ממה שמכיר רוב האנשים. כמות החמצן הזמינה בפסגה היא כמחצית ממה שזמין בגובה פני הים. הגוף עובד קשה יותר על כל צעד. הנשימה כבדה, הרגליים כבדות, המחשבה מתקשה. ואנשים שמגיעים לקילימנג\'רו בכושר מצוין מגלים לפעמים, להפתעתם, שגופם מסרב לשתף פעולה כבר ב-4,500 מ׳. זו לא חולשה. זו ביולוגיה.' },

      { type: 'image', src: '/images/blog/kilimanjaro-trekkers.webp', alt: 'מטפסים בדרך לפסגת קילימנג\'רו', caption: 'בדרך לפסגה: כל צעד בגובה מעל 4,500 מ׳ כבד יותר ממה שמצפים' },
      ...
      { type: 'text', value: 'כעשרה אחוז מהמטפסים שמגיעים למחנה הגבוה אינם מסיימים את ההעפלה הסופית. חלקם מגיעים עד "סטלה פוינט", 5,739 מ׳, שגם הגעה אליה היא הישג של ממש. השאר מסתובבים קודם, לרוב בגלל מחלת גובה. אין בזה כישלון. ההחלטה לרדת כשהגוף מבקש זאת היא ההחלטה הנבונה.' },
  ...
  /*
  {
    ...
    content: [
      ...
      { type: 'callout', title: '✦ שלושה יתרונות שמייחדים את מאצ׳אמה', items: [
        ...
        'אקלום: המסלול בנוי סביב עיקרון "טפס גבוה, ישן נמוך". ביום השלישי, למשל, המסלול מטפס אל מגדל הלבה מעל 4,600 מ׳, ואז יורד לישון נמוך יותר במחנה בראנקו. התנועה הזו מאמנת את הגוף להתמודד עם הגובה.',
      ...
      { type: 'text', value: 'מ-1,800 מ׳ אל כ-2,850 מ׳. כ-5 עד 7 שעות הליכה. היום מתחיל בנסיעה אל השער, ואז עלייה דרך יער גשם טרופי ולח. השביל עלול להיות בוצי ומקלות הליכה עוזרים.' },

      { type: 'heading', value: 'יום 2: מחנה מאצ׳אמה אל מחנה שירה' },
      { type: 'text', value: 'אל כ-3,800 מ׳. כ-4 עד 6 שעות. יוצאים מיער הגשם ונכנסים לאזור אדמות הבור, לאורך רכס סלעי. נפתחים נופים אל מישור שירה ואל הר מרו במרחק.' },

      { type: 'heading', value: 'יום 3: שירה אל מגדל הלבה ואל מחנה בראנקו' },
      { type: 'text', value: 'עלייה אל כ-4,600 מ׳ במגדל הלבה, ואז ירידה אל מחנה בראנקו בכ-3,900 מ׳. כ-6 עד 7 שעות. זהו יום האקלום המרכזי: מסיימים את היום באותו גובה שבו התחלתם בערך, אבל הגוף "טעם" את הגובה הרב. יום קריטי להכנת הגוף לקראת הפסגה.' },
      ...
      { type: 'text', value: 'אל כ-4,600 מ׳. יום קצר, כ-3 עד 4 שעות. עלייה אל בייס קמפ לפסגה. מגיעים מוקדם בכוונה, כדי לנוח, לאכול, ולהתכונן להעפלה. ארוחת ערב מוקדמת, ואז שינה קצרה לפני היציאה.' },

      { type: 'heading', value: 'יום 6: יום הפסגה, מחנה בראפו אל אורו פיק וירידה אל מחנה מווקה' },
      { type: 'text', value: 'זהו היום הגדול והארוך ביותר. יוצאים בלילה ומטפסים בחושך אל סטלה פוינט, ומשם אל פסגת אורו פיק, 5,895 מ׳, הנקודה הגבוהה ביבשת אפריקה. אחרי הפסגה מתחילה ירידה ארוכה אל מחנה מווקה. סך הכל יום של שעות רבות על הרגליים.' },
      ...
      { type: 'text', value: 'כל מסלולי קילימנג׳רו מובילים לאותה פסגה: אורו פיק, בגובה 5,895 מ׳, הנקודה הגבוהה ביבשת אפריקה.' },
    ],
   ...
   * ═══════════════════════════════════════════════════════════════════ */
  {
    ...
    category: 'קילימנג׳רו',
    categoryEn: 'Kilimanjaro',
    img:             '/images/blog/tanzania-currency.jpg',
    imgPosition:     'center 45%',
    imgPositionCard: 'center 45%',
    imgCredit:       '',
   ...
   * ═══════════════════════════════════════════════════════════════════ */
  {
    ...
    category: 'קילימנג׳רו',
    categoryEn: 'Kilimanjaro',
    img:             '/images/blog/tanzania-vaccinations.jpg',
    imgPosition:     'center 45%',
    imgPositionCard: 'center 45%',
    imgCredit:       '',
    ...
    content: [
      ...
      { type: 'text', value: 'קילימנג׳רו מתנשא ל-5,895 מ׳, ומחלת גבהים היא האתגר המרכזי בטיפוס. מסלול מקצועי בנוי כך שהגוף יתאקלם בהדרגה, אך רופא במרפאת המטיילים עשוי לרשום גם תרופה שמסייעת בהתמודדות עם הגובה. התרופה הנפוצה ביותר לכך היא אצטאזולמיד, המוכרת בישראל בשמות המסחריים אורמוקס ודיאמוקס. ההחלטה על נטילתה היא תמיד אישית ורפואית.' },
      ...
      { type: 'text', value: 'כדאי להבהיר נקודה שלעיתים מתבלבלים בה: חיסונים ותרופות מגנים מפני מחלות, אך הם אינם פותרים את הגובה. ההתמודדות עם הגובה נשענת על דבר אחר לגמרי: התאקלמות נכונה.' },
      { type: 'text', value: 'הטיפוס בקילימנג׳רו מתוכנן כך שהגוף יתרגל לגובה בהדרגה, יום אחר יום. לצד התכנון, התפקיד שלכם הוא להקשיב לגוף, לשתות הרבה מים, ולעלות בקצב נוח. שילוב של הכנה רפואית נכונה מראש והתאקלמות מבוקרת על ההר הוא מה שמביא אתכם לפסגה בריאים.' },
      ...
      { type: 'text', value: 'לא. ההתמודדות עם הגובה נשענת על התאקלמות הדרגתית לאורך הטיפוס. רופא עשוי לרשום תרופה שמסייעת, אך היא אינה תחליף להתאקלמות נכונה.' },
   ...
   * ═══════════════════════════════════════════════════════════════════ */
  {
    ...
    category: 'קילימנג׳רו',
    categoryEn: 'Kilimanjaro',
    img:             '/images/blog/tanzania-visa.jpg',
    imgPosition:     'center 40%',
    imgPositionCard: 'center 40%',
    imgCredit:       '',
   ...
   * ═══════════════════════════════════════════════════════════════════ */
  {
    ...
    content: [
      ...
      { type: 'text', value: 'עבורו, כל מטר של עלייה הוא משיכה של מלוא משקל הגוף כלפי מעלה, בכוח הידיים, באוויר שבו יש שליש מהחמצן שיש בגובה פני הים. נבייב טיפס עם גרזני קרח, נעזר בחמש שרפות ובשלושה מדריכים. הוא יצא מבייס קמפ ב-13 במאי, יום הולדתו ה-34, וחצה את ארבעת המחנות הגבוהים עד שעמד על הפסגה שבוע מאוחר יותר.' },
      ...
      { type: 'image', src: '/images/blog/nabiev-summit.jpg', alt: 'פסגת האוורסט בעונת 2026', caption: 'פסגת האוורסט, 8,848 מ׳. ב-20 במאי 2026 עמד עליה אדם ללא רגליים' },
      ...
      { type: 'text', value: 'בין השאר אלברוס, קזבק, אררט, קילימנג\'רו, אקונקגואה, ובאוקטובר 2021 את מנסלו, פסגה בת 8,163 מ׳, ובכך הפך למטפס הקטוע-רגליים הראשון שמגיע לפסגת הר מעל 8,000 מ\' ללא תותבות.' },
      { type: 'heading', value: 'כמה זמן לקח לנבייב לטפס על האוורסט?' },
      { type: 'text', value: 'נבייב יצא מבייס קמפ ב-13 במאי 2026, יום הולדתו ה-34, וחצה ארבעה מחנות בגובה הולך וגדל. הוא הגיע לפסגה ב-20 במאי, שבעה ימים מאוחר יותר.' },
    ],
   ...
   * ═══════════════════════════════════════════════════════════════════ */
  {
    ...
    /* ── Hebrew ── */
    title:    'קריסטין הרילה ושלושת הכתרים של האוורסט: המסע אל מה שאף אישה לא השלימה',
    author:   'HighAir Expeditions',
    dateIso:  '2026-05-27',
    ...
    imgCredit:       '',
    excerpt:  'בעונת 2026 השלימה המטפסת הנורווגית את שלושת הכתרים של האוורסט, הישג שרק ארבעה אנשים עשו לפניה, ואף אישה. אבל מתחת לשיא הספורטיבי מסתתר סיפור על אובדן, על הר אחד באוקטובר, ועל הסיבה האמיתית שבגללה היא חזרה.',
    excerptEn: 'In the 2026 season the Norwegian climber completed the Everest Triple Crown, a feat only four people had achieved before her, and no woman. But beneath the sporting achievement lies a story of loss, one mountain in October, and the real reason she came back.',

    /* ── Hebrew content ── */
    content: [
      { type: 'text', value: 'בבוקר ה-27 במאי 2026 עמדה קריסטין הרילה על פסגת האוורסט, 8,849 מ׳, הנקודה הגבוהה ביותר על פני כדור הארץ. עם ההעפלה הזו היא השלימה את "שלושת הכתרים", נופטסה, להוצה והאוורסט, שלוש הפסגות הגבוהות באזור האוורסט, בעונת טיפוס אחת. רק ארבעה בני אדם בהיסטוריה עשו זאת לפניה, ואף אישה לא הייתה ביניהם.' },
      { type: 'text', value: 'אבל כדי להבין למה ההעפלה הזו חשובה כל כך, לא רק להרילה אלא לכל מי שאוהב הרים, צריך לחזור שלוש שנים אחורה, אל הר אחר, ואל יום אחד באוקטובר.' },
      ...
      { type: 'text', value: 'האתגר שהרילה בחרה נקרא "שלושת הכתרים של האוורסט" (The Everest Triple Crown). הרעיון פשוט להגדרה וקשה מנשוא לביצוע: לטפס בעונה אחת על שלוש הפסגות הגבוהות ביותר באזור האוורסט.' },
      { type: 'subheading', value: 'נופטסה, 7,861 מ׳' },
      { type: 'text', value: 'השכנה התלולה והטכנית של האוורסט. פסגה שנחשבת קשה גם למטפסים מנוסים. הרילה העפילה לפסגת נופטסה ב-17 במאי 2026, ללא חמצן משלים.' },
      { type: 'image', src: '/images/blog/harila-nuptse-summit.jpg', alt: 'קריסטין הרילה בפסגת נופטסה עם דגל נורווגיה', caption: 'קריסטין הרילה בפסגת נופטסה, 17 במאי 2026. גובה 7,861 מ׳, ללא חמצן משלים' },
      { type: 'subheading', value: 'להוצה, 8,516 מ׳' },
      { type: 'text', value: 'ההר הרביעי בגובהו בעולם, צמוד לאוורסט וחולק איתו חלק מן המסלול. הרילה העפילה לפסגת להוצה ב-21 במאי 2026.' },
      { type: 'image', src: '/images/blog/harila-lhotse-summit.jpg', alt: 'קריסטין הרילה כורעת על פסגת להוצה עם דגל נורווגיה', caption: 'קריסטין הרילה בפסגת להוצה, 21 במאי 2026. גובה 8,516 מ׳' },
      { type: 'subheading', value: 'האוורסט, 8,849 מ׳' },
      ...
      { type: 'image', src: '/images/blog/harila-everest-summit.jpg', alt: 'קריסטין הרילה בפסגת האוורסט עם שלט MT. EVEREST Spring 2026', caption: 'קריסטין הרילה בפסגת האוורסט, 27 במאי 2026. גובה 8,849 מ׳, השלמת שלושת הכתרים' },
      ...
      { type: 'text', value: 'בגבהים שמעל 8,000 מ׳, באזור שמטפסים מכנים "אזור המוות", כמות החמצן בכל נשימה צונחת לכשליש מזו שבגובה פני הים. הגוף האנושי באזור הזה דועך, הוא צורך את עצמו מהר יותר משהוא מתאושש. רוב המטפסים שמעפילים ללהוצה ולאוורסט עושים זאת עם מסכת חמצן, וזה אינו פינוק אלא כלי בטיחות שמפחית דרמטית את הסיכון לנזק גופני קבוע.' },
      { type: 'callout', title: '✦ מה זה "אזור המוות"?', value: 'גובה מעל 8,000 מ׳ שבו אין מספיק חמצן בסביבה כדי לקיים חיים אנושיים לאורך זמן. הגוף מתחיל לצרוך רקמות שרירים כדי לתפקד. כל שעה שעוברת בגובה הזה גובה מחיר.' },
      { type: 'text', value: 'לטפס את שלושת הכתרים בלי חמצן פירושו להכפיל את הקושי ואת הסיכון כאחד.' },
      { type: 'text', value: 'ההחלטה הזו גם עוררה ביקורת. מבקרים ציינו שלמרות שיא 14 הפסגות מעל 8,000 מ\', להרילה ניסיון מועט יחסית בטיפוס בגובה קיצוני בלי חמצן, שכן בשיא ההוא היא כן השתמשה בו. הרילה השיבה שסגנון הטיפוס המהיר שלה הותיר אותה פעמים רבות מטפסת בלי חמצן בפועל, ושכספורטאית היא סקרנית לדעת איך גופה יגיב.' },
      { type: 'text', value: 'בסופו של דבר, המציאות של ההר אמרה את דברה. נופטסה והאוורסט נעשו ללא חמצן, אך בלהוצה, לפי דיווח של אתר The Tourism Times שציטט את מנהל המשלחת מטעם Seven Summit Treks, נעזרה הרילה בחמצן. אפשר לראות בכך כישלון של התוכנית המקורית, ואפשר לראות בכך בדיוק את מה שהופך את הסיפור לאנושי: גם המטפסים הגדולים בעולם נתקלים בגבול, מתפשרים על פרט, וממשיכים. הרילה לא ויתרה על האתגר. היא המשיכה, והשלימה את שלושת הכתרים.' },
      ...
      { type: 'text', value: 'ההעפלה הראשונה של הרילה לגובה רב לא הייתה על פסגה מעל 8,000 מ\'. היא הייתה על לובוצ\'ה, פסגה באזור האוורסט שגובהה כ-6,100 מ׳. זה היה ב-2019. הרילה סיפרה שהיא זוכרת את הטיפוס ההוא כקשה. כמאמץ אמיתי. שש שנים מאוחר יותר, אותה אישה מטפסת על אותו הר בתוך פחות משלוש שעות.' },
      ...
      { type: 'image', src: '/images/blog/lobuche-peak.jpg', caption: 'לובוצ\'ה פיק, 6,119 מ׳, ההר שממנו התחיל המסע של קריסטין הרילה' },
      ...
      { type: 'text', value: 'טיפוס בעונה אחת על שלוש הפסגות הגבוהות באזור האוורסט: נופטסה (7,861 מ׳), להוצה (8,516 מ׳) והאוורסט (8,848 מ׳). רק ארבעה אנשים בהיסטוריה השלימו את הרצף הזה.' },
      { type: 'heading', value: 'האם קריסטין הרילה השלימה את שלושת הכתרים?' },
      { type: 'text', value: 'כן. ב-27 במאי 2026 העפילה הרילה לפסגת האוורסט והשלימה את שלושת הכתרים כאישה הראשונה בהיסטוריה. נופטסה והאוורסט נעשו ללא חמצן משלים; בלהוצה, לפי דיווחים בתקשורת הנפאלית, היא נעזרה בחמצן, ולכן האתגר לא הושלם בגרסת ה"ללא חמצן" המלאה שתוכננה.' },
      ...
      { type: 'text', value: 'ב-2023, הרילה וטנזין לאמה שרפה העפילו לכל 14 ההרים מעל 8,000 מ׳ בתוך 92 ימים, שיא עולם. הטיפוס ההוא כלל שימוש בחמצן משלים.' },
      { type: 'heading', value: 'למה טיפוס ללא חמצן נחשב לקשה כל כך?' },
      { type: 'text', value: 'בגובה רב כמות החמצן בכל נשימה צונחת דרמטית. מעל 8,000 מ׳ הגוף אינו מסוגל להתאושש. ויתור על חמצן משלים מגדיל מאוד את המאמץ ואת הסיכון, ושמור למטפסי עילית.' },
    ],

    /* ── English content ── */
    titleEn: 'Kristin Harila and the Everest Triple Crown: The Journey to What No Woman Had Ever Completed',
    contentEn: [
      { type: 'text', value: 'On the morning of 27 May 2026, Kristin Harila stood on the summit of Everest at 8,849 metres, the highest point on Earth. With that ascent she completed the Everest Triple Crown, Nuptse, Lhotse and Everest, the three highest peaks of the Everest massif, in a single climbing season. Only four people in history had done this before her, and no woman had ever been among them.' },
      { type: 'text', value: 'But to understand why this achievement matters so much, not just for Harila but for everyone who loves mountains, you have to go back three years, to a different mountain, and to one day in October.' },
      ...
      { type: 'text', value: 'The steep and technically demanding neighbour of Everest. A peak considered difficult even for experienced climbers. Harila summited Nuptse on 17 May 2026, without supplemental oxygen.' },
      { type: 'image', src: '/images/blog/harila-nuptse-summit.jpg', alt: 'Kristin Harila on the summit of Nuptse holding the Norwegian flag', caption: 'Kristin Harila on the summit of Nuptse, 17 May 2026. 7,861 metres, without supplemental oxygen' },
      { type: 'subheading', value: 'Lhotse, 8,516 metres' },
      { type: 'text', value: 'The fourth highest mountain in the world, adjacent to Everest and sharing part of its route. Harila summited Lhotse on 21 May 2026.' },
      { type: 'image', src: '/images/blog/harila-lhotse-summit.jpg', alt: 'Kristin Harila kneeling on the snowy summit of Lhotse with the Norwegian flag', caption: 'Kristin Harila on the summit of Lhotse, 21 May 2026. 8,516 metres' },
      ...
      { type: 'heading', value: 'Has Kristin Harila completed the Everest Triple Crown?' },
      { type: 'text', value: 'Yes. On 27 May 2026 Harila summited Everest and became the first woman in history to complete the Triple Crown. Nuptse and Everest were climbed without supplemental oxygen; on Lhotse, according to reports citing the expedition manager, she used oxygen, meaning the challenge was not completed in the fully oxygen-free version originally planned.' },
   ...
   * ═══════════════════════════════════════════════════════════════════ */
  {
    ...
    content: [
      ...
      { type: 'text', value: 'לפני כשלושה שבועות, בסוף אפריל, גוש קרח עצום קרס וחסם את מפל הקרחון של קוחומבו, הקטע המסוכן ביותר במסלול הצד הדרומי, וצוואר הבקבוק שדרכו חייבים לעבור כל המטפסים. מאות מטפסים תקעו את מהלכם בבייס קמפ במשך ימים, עד שיחידת אייספול דוקטורס של השרפה הצליחה לקבע מחדש סולמות וחבלים ולפתוח את הנתיב.' },
   ...
   * ═══════════════════════════════════════════════════════════════════ */
  {
    ...
    content: [
      ...
      { type: 'text', value: 'מהקילימנג\'רו. לא כי זה הכי קל, אלא כי זה ההר שעונה על השאלה שחשובה יותר מכל שאלת גובה: האם גוף ונפש מחוברים לאותה יציאה למסע. קילימנג\'רו נותן לכם שישה עד שמונה ימים לגלות את התשובה, מוקפים בנוף שלא ידעתם שאתם צריכים לראות, ועם 5,895 מ׳ שממתינים בסוף.' },
