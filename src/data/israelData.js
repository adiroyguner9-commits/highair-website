...
export const ISRAEL_TRIPS = [
  ...
  /* ── Community trip — Nahal El Al ── */
  {
    ...
    hidden:       false,
    showIntro:    true,
    img:          '/images/cards/elal.webp',
    grad:         'linear-gradient(135deg, #0c3b4a, #1a7a8a, #062830)',
    diffHe:       'בינוני',
    diffEn:       'Moderate',
    days:         'יום אחד',
    daysEn:       '1 day',
    ...
    distance:     '9 ק"מ',
    elevGain:     '+250 מ׳',
    tagline:      'טיול קהילה של HighAir בנחל אלעל שבדרום הגולן',
    taglineEn:    'HighAir community trip at Nahal El Al in the southern Golan',
    seoTitle:       'HighAir Expeditions | טיול קהילה - נחל אלעל',
    seoTitleEn:     'HighAir Expeditions | Community Trip - Nahal El Al',
    seoDescription: 'טיול קהילה של HighAir בנחל אלעל - יום שישי 07/08. מסלול מים בדרום הגולן עם המפל הלבן והמפל השחור, בריכות רחצה ומדריך מוסמך.',
    seoDescriptionEn: 'HighAir community trip at Nahal El Al - Friday 07/08. A water trail in the southern Golan featuring the White and Black waterfalls, natural pools and a certified guide.',
    desc:         'נחל אלעל הוא אחד הנחלים היפים בדרום רמת הגולן - נחל איתן הזורם כל השנה, עם שני מפלים מפורסמים: המפל הלבן, הזורם על סלע גיר בהיר, והמפל השחור, הזורם בין סלעי בזלת כהים.\n\nהמסלול עובר לאורך ערוץ הנחל בין המפלים, עם בריכות רחצה טבעיות ונקודות עצירה מרעננות - מסלול קיץ מושלם לקהילת HighAir, להכיר חברים חדשים למסעות הבאים וליהנות יחד מהטבע הישראלי.',
    descEn:       'Nahal El Al is one of the most beautiful streams in the southern Golan Heights - a perennial stream flowing year-round, with two famous waterfalls: the White Waterfall, cascading over bright limestone, and the Black Waterfall, flowing between dark basalt rocks.\n\nThe trail follows the stream bed between the waterfalls, with natural swimming pools and refreshing stops along the way - a perfect summer route for the HighAir community, to meet future expedition friends and enjoy the Israeli outdoors together.',
    airtableEvents: ['ElAlCommunity'],
    groupCapacity:  20,
    gear: [
      'תרמיל גב (חובה!)',
      'חולצת ומכנס טיולים (חובה!)',
    ...
    itinerary: [
      {
        day:           'יום שישי - 07/08/26',
        title:         '',
        desc:          '06:30 - נפגשים בנקודת מפגש\n07:00 - תחילת המסלול\n13:00 - סיום וארוחת צהריים מפנקת\n13:30 - סיום משוער ושבת שלום!',
        distance:      '9 ק"מ',
        duration:      '',
        elevationGain: '+250 מ׳ טיפוס מצטבר',
      },
    ],
    itineraryEn: [
      {
