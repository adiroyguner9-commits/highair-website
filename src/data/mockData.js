...
Join us on this incredible adventure to the Peak of the Gods and make a meaningful contribution to the fight against cancer!`,
    ...
    importantToNote: [
      'האולימפוס מתבצע בקבוצה עד 15 משתתפים  -  לא יותר, זה חלק מהחוויה!',
      'נדרשת הנעלת טרק/הרים עם קרסול מוגבה וסוליה מחוספסת  -  נעלי ריצה לא מתאימות לטיפוס לפסגת מיטיקאס!',
      'מזג האוויר על האולימפוס יכול להשתנות במהירות  -  ענן, רוח וברק מופיעים ללא אזהרה. המדריכים מחליטים בשטח.',
      'ביום הקניונינג (יום 5) נדרשת שחייה בסיסית  -  אנא עדכנו אותנו מראש אם אינכם שוחים.',
      'אישור רפואי והצהרת בריאות נדרשים כתנאי ליציאה למסע!',
      'אין צורך בניסיון טיפוס קודם  -  מי שמסוגל להליכה של 15-20 ק"מ ביום עם עליות יגיע לפסגה.',
      'בטיחות לפני פסגה  -  בהרים אין הבטחה להגיע לפסגה, אך יש תמיד התחייבות לבטיחות.',
    ],
    importantToNoteEn: [
...
Join us for a once-in-a-lifetime adventure, and make a meaningful contribution to the fight against cancer!`,
    ...
    importantToNote: [
      'טרק הבלקן חוצה 3 מדינות  -  יש להצטייד בדרכון בתוקף ולוודא שאין מגבלות כניסה לאלבניה, קוסובו ומונטנגרו.',
      'הלינה בגסטהאוסים ביתיים  -  החדרים פשוטים, המזון ביתי ואמיתי. לא ממליצים למי שמחפש נוחות של מלון.',
      'ימי ההליכה נעים בין 13-22 ק"מ  -  נדרש כושר הליכה טוב ויכולת לשאת כתף במשך 7-9 שעות ביום.',
      'הסלולר עשוי לא לקלוט בחלק מהמקטעים  -  מכשיר לוויין כלול בחבילה לבטיחות הקבוצה.',
      'אישור רפואי והצהרת בריאות נדרשים כתנאי ליציאה למסע!',
      'אין צורך בניסיון טיפוס קודם  -  זהו טרק ללא טיפוס טכני, אך הצטברות הימים דורשת כושר סביר.',
      'בטיחות לפני פסגה  -  הבטיחות תמיד קודמת לכל.',
    ],
    importantToNoteEn: [
...
This journey combines the contrast between desert heat and cold mountain winds - an unforgettable experience of nature in all its glory!`,
    ...
    importantToNote: [
      'חיסון נגד קדחת צהובה חובה לכניסה לאתיופיה  -  יש להציג תעודת חיסון בשדה התעופה. בנוסף מומלצים: מלריה, טיפוס, הפטיטיס A ופוליו.',
      'מדבר דנקיל הוא אחד המקומות החמים בעולם  -  הטמפרטורה מגיעה ל-50°C. הדרישה הפיזית עיקרית היא ניהול חום ושתיית מים מרובה.',
      'ביקור בארטה אלה (אגם הלבה) נעשה בלילה ובליווי משמרות חמושים  -  זוהי דרישת הרשויות המקומיות ומהווה תנאי לכניסה לאזור.',
      'הקבוצה מוגבלת ל-15 משתתפים  -  עם מלווה ישראלי דובר עברית לאורך כל המסע.',
      'אישור רפואי והצהרת בריאות נדרשים  -  כולל בדיקת כשירות להתמודדות עם חום קיצוני ועלייה לגובה 4430מ׳.',
      'מטייל שלא יעמוד בדרישות הבריאותיות לא יורשה להצטרף.',
      'בטיחות לפני הכל  -  אין הבטחה להגיע לכל נקודה, אך תמיד יש התחייבות לבטיחות.',
    ],
    importantToNoteEn: [
...
This is a true mountaineering expedition requiring crampons, ice axes, and rope work - perfect for climbers looking for their first high-altitude experience beyond trekking peaks.`,
    ...
    importantToNote: [
      'קזבק דורש עבודה עם קרמפונים וגרזן קרח  -  הציוד כלול. מתבצע אימון מעשי במהלך ימי ההתאקלמות לפני יום הפסגה.',
      'יום הפסגה מתחיל בחצות (00:00-01:00) ונמשך 10-12 שעות  -  נדרש כושר גופני גבוה ויכולת מנטלית לצעידה ממושכת בגובה 5054מ׳.',
      'הקרחון עשוי להכיל בקעים  -  ההליכה מתבצעת תמיד בקבוצה עם חבלים. אין הליכה עצמאית מחוץ לקבוצה.',
      'גאורגיה לא דורשת ויזה לאזרחי ישראל  -  דרכון בתוקף מספיק לכניסה.',
      'אישור רפואי והצהרת בריאות נדרשים  -  כולל בדיקת כשירות לגובה 5000מ׳ ועבודה אלפינית.',
      'אין צורך בניסיון טיפוס קודם  -  אך כושר גופני גבוה ויציבות נפשית בגובה הם תנאי הכרחי.',
      'בטיחות לפני פסגה  -  החלטת ההגעה לפסגה תמיד בידי המדריך.',
    ],
    importantToNoteEn: [
...
Join us for a once-in-a-lifetime adventure in the Himalayas and take part in the fight against cancer!`,
    ...
    groupCapacity: 15,
    importantToNote: [
      'טרק מנסלו עובר דרך אזור מוגבל (Restricted Area)  -  היתר מיוחד כלול בחבילה. לא ניתן לגשת לאזור ללא אישור רשמי.',
      'גם כרטיס TIMS ואישור שמורת מנסלו הלאומית כלולים  -  אין צורך בהסדרים עצמאיים.',
      'טיסת לוקלה עלולה להתבטל בגלל מזג אוויר  -  ביום הראשון מומלץ לא לתכנן טיסות קשיחות הביתה. מוסיפים יום חיץ בתכנון.',
      'מעבר לרקיה לה (5106מ׳) הוא היום הארוך והקשה ביותר  -  יציאה לפני עלות השחר ב-03:00-04:00.',
      'אישור רפואי והצהרת בריאות נדרשים  -  כולל כשירות לגובה 5000מ׳ ו-16 ימי הליכה רצופים.',
      'הטרק מתבצע בקבוצה עד 15 משתתפים עם מדריכים מנוסים.',
      'בטיחות לפני פסגה  -  תמיד התחייבות לבטיחות מעל הכל.',
    ],
    importantToNoteEn: [
...
Join us for a once-in-a-lifetime adventure in the Himalayas and take part in the fight against cancer!`,
    ...
    importantToNote: [
      'טיסת לוקלה (2860מ׳) היא אחת מהטיסות המאתגרות בעולם  -  עיכובים וביטולים בגלל מזג אוויר שכיחים. כלול יום חיץ בתכנון.',
      'כרטיס TIMS ואישור שמורת סגרמתה (Sagarmatha) כלולים בחבילה.',
      'מחלת גובה (AMS) היא הסיכון העיקרי מעל 3500מ׳  -  חשוב לשתות הרבה מים, ללכת לאט ולדווח מיד על כאבי ראש חריפים, הקאות או בלבול.',
      'אם הגובה לא מאפשר המשך  -  יש לרדת מיד. ProtocolAMS מוסבר מראש לכל המשתתפים.',
      'הטרק מתבצע בקבוצה עד 15 משתתפים עם מדריכי שרפה מנוסים.',
      'אישור רפואי והצהרת בריאות נדרשים  -  כולל כשירות לגובה 5364מ׳.',
      'בטיחות לפני פסגה  -  הגעה לבייס קמפ אינה מובטחת אך הבטיחות תמיד קודמת.',
    ],
    importantToNoteEn: [
...
This 14-day adventure takes you through traditional Gurung and Manangi villages, past ancient Buddhist monasteries, and through the dramatic Kali Gandaki gorge - the world's deepest valley.`,
    ...
    importantToNote: [
      'טרק אנאפורנה דורש אישורי ACAP ו-TIMS  -  שניהם כלולים בחבילה.',
      'מעבר תורונג לה (5416מ׳) נעשה בקור עז ולעיתים ברוח חזקה  -  נדרשת ציוד חורפי מלא כולל שכבות תרמיות, כפפות ורכסני פנים.',
      'היציאה למעבר מאנאפורנה היי קמפ היא לפני עלות השחר (03:00-04:00) כדי להגיע לפסגה לפני שמזג האוויר מתדרדר.',
      'הצד השני של המעבר יורד כ-1600מ׳ ב-10 ק"מ  -  נדרשת ברכיים בריאות.',
      'אישור רפואי והצהרת בריאות נדרשים  -  כולל כשירות לגובה 5416מ׳ ו-16 ימי הליכה.',
      'הטרק מתבצע בקבוצה עד 15 משתתפים.',
      'בטיחות לפני פסגה  -  תנאי מזג האוויר בתורונג לה עלולים לדחות את המעבר. הכרעה בידי המדריכים.',
    ],
    itineraryEn: [
...
This is a non-technical climb requiring crampons and ice axes, but no prior mountaineering experience is needed - just good physical fitness and the will to stand on top of Europe.`,
    ...
    importantToNote: [
      'האלברוס הוא 5642מ׳  -  הגבוה מכל הר באלפים, בקווקז ובאירופה. הגובה משפיע בצורה שלא ניתן לחזות מראש גם על אנשים בריאים לחלוטין.',
      'יום הפסגה נמשך 10-14 שעות  -  יציאה בין 02:00-04:00 לפנות בוקר. נדרש כושר גופני גבוה ויכולת מנטלית חזקה.',
      'ניתן לעלות עם שינקת שלג (snow cat) עד 4800מ׳ בתוספת תשלום, לחיסכון באנרגיה. ממוליצים לאלה עם פחות ניסיון בגובה.',
      'כרטיסי הכבלית לאזור גרה-בשי כלולים בחבילה. הסכנה העיקרית: היפותרמיה וכוויות קור  -  ציוד חורפי מלא חובה.',
      'אישור רפואי והצהרת בריאות נדרשים  -  כולל כשירות לטיפוס בגובה 5642מ׳.',
      'אין צורך בניסיון טיפוס קודם  -  אך כושר גופני גבוה ויציבות נפשית בגובה הם הכרחיים.',
      'בטיחות לפני פסגה  -  החלטת ההגעה לפסגה תמיד בידי המדריך.',
    ],
    itinerary: [
...
HighAir's Kilimanjaro expeditions have a 94% summit success rate - one of the highest in the industry - thanks to our experienced Israeli guides and careful acclimatization schedule.`,
    ...
    importantToNote: [
      'ויזה לטנזניה בעלות 50 דולר לאדם  -  מומלץ להוציא אונליין מראש (eVisa) ולא לסמוך על הוצאה בשדה התעופה. תוקף 90 יום.',
      'מסלול מאצ׳מה (7 ימים) הוא מסלול ההצלחה הגבוה ביותר בקילימנג׳רו, עם ימי עלייה-ירידה להתאקלמות. שיעור ההצלחה שלנו עומד על 94%.',
      'יום הפסגה מתחיל בחצות (00:00) ונמשך כ-16 שעות  -  נדרש ציוד חורפי מלא לתנאים של -15°C ורוחות חזקות על הפסגה.',
      'לינה באוהלים לאורך כל המסלול  -  הציוד (אוהלים, מזרנים) מסופק. נדרש שק שינה עד -15°C.',
      'אישור רפואי והצהרת בריאות נדרשים  -  כולל כשירות לגובה 5895מ׳.',
      'אין צורך בניסיון טיפוס קודם  -  מי שמסוגל ללכת 8-10 שעות ביום יגיע לפסגה.',
      'בטיחות לפני פסגה  -  המדריך מחליט אם להמשיך בהתאם למצב כל משתתף.',
    ],
    importantToNoteEn: [
...
Glatt kosher meals throughout · Shabbat-aware scheduling · Hebrew + English guides · Cancer charity donation included`,
    ...
    importantToNote: [
      'ויזה לטנזניה בעלות 50 דולר לאדם  -  מומלץ להוציא אונליין מראש (eVisa). תוקף 90 יום.',
      'כל האוכל כשר בהשגחה מלאה  -  מטבח נפרד, כלים נפרדים ושחיטה לפי ההלכה. מתאים גם לשומרי שבת.',
      'יום הפסגה מתחיל בחצות (00:00)  -  נדרש ציוד חורפי מלא לתנאים של -15°C ורוחות על הפסגה.',
      'מסלול מאצ׳מה 7 ימים  -  שיעור ההצלחה שלנו עומד על 94% הודות לימי ההתאקלמות המוכללים.',
      'אישור רפואי והצהרת בריאות נדרשים  -  כולל כשירות לגובה 5895מ׳.',
      'אין צורך בניסיון טיפוס קודם  -  מי שמסוגל ללכת 8-10 שעות ביום יגיע לפסגה.',
      'בטיחות לפני פסגה  -  המדריך מחליט אם להמשיך בהתאם למצב כל משתתף.',
    ],
...
This peak is considered one of the best entry points into Himalayan mountaineering - challenging enough to be meaningful, achievable with proper training.`,
    ...
    importantToNote: [
      'לובוצ׳ה פיק (6119מ׳) דורש טיפוס טכני  -  שימוש בחבלים קבועים, ג׳ומאר, קרמפונים וגרזן קרח. אימון מלא מסופק לפני יום הפסגה.',
      'היתר טיפוס מ-Nepal Mountaineering Association כלול בחבילה.',
      'הטיפוס משולב עם טרק לבייס קמפ אוורסט  -  19 ימים סה"כ, הכוללים ימי התאקלמות מספקים לגובה 6119מ׳.',
      'יום הפסגה נמשך 10-12 שעות  -  נדרש כושר גופני גבוה וניסיון בהליכה בגובה.',
      'אישור רפואי והצהרת בריאות נדרשים  -  כולל כשירות לגובה 6000מ׳.',
      'ניסיון קודם בטרק בגובה מומלץ  -  הטיפוס הטכני ניתן ללמידה, אך גובה 6000מ׳ מחייב ניסיון מוקדם.',
      'בטיחות לפני פסגה  -  החלטת ההמשך תמיד בידי המדריך.',
    ],
    importantToNoteEn: [
...
This expedition can be combined with the Everest Base Camp trek, creating the ultimate Himalayan adventure in a single trip.`,
    ...
    importantToNote: [
      'אייילנד פיק (6189מ׳) דורש טיפוס טכני בחלק העליון  -  ג׳ומאר על חבלים קבועים, קרמפונים וגרזן קרח. אימון מסופק לפני יום הפסגה.',
      'היתר טיפוס מ-Nepal Mountaineering Association כלול בחבילה.',
      'הטיפוס משולב עם טרק לבייס קמפ אוורסט  -  20 ימים סה"כ כולל ימי התאקלמות לגובה 6189מ׳.',
      'יום הפסגה מתחיל לפני עלות השחר (02:00-03:00) ונמשך 12-14 שעות  -  נדרש כושר גופני גבוה.',
      'אישור רפואי והצהרת בריאות נדרשים  -  כולל כשירות לגובה 6000מ׳.',
      'ניסיון קודם בטרק בגובה מומלץ  -  עדיף ניסיון על מסלולים בגובה 4500מ׳ ומעלה לפחות.',
      'בטיחות לפני פסגה  -  ההחלטה על ההמשך תמיד בידי המדריך.',
    ],
    importantToNoteEn: [
...
Non-technical but high-altitude, Mera is perfect for fit trekkers who want to experience what it feels like to stand above 6000 meters.`,
    ...
    importantToNote: [
      'מרה פיק (6476מ׳) היא הפסגה הגבוהה ביותר לטרקינג בנפאל  -  גבוהה יותר מכל פסגה באלפים, אך ללא טיפוס טכני מורכב.',
      'הטיפוס דורש קרמפונים וגרזן קרח ועבודה בחבלים בחלקים הגלאציאריים  -  אימון מסופק לפני יום הפסגה.',
      'היתר טיפוס מ-Nepal Mountaineering Association כלול בחבילה.',
      'מהפסגה נשקפת פנורמה על 5 שמיניות: אוורסט (8849מ׳), לוצה (8516מ׳), מאקלו (8463מ׳), צ׳ו אויו (8188מ׳) וקנצ׳נג׳ונגה (8586מ׳).',
      'אישור רפואי והצהרת בריאות נדרשים  -  כולל כשירות לגובה 6476מ׳.',
      'ניסיון קודם בטרקינג בגובה מומלץ  -  עדיף ניסיון על מסלולים בגובה 4500מ׳ ומעלה.',
      'בטיחות לפני פסגה  -  ההחלטה על ההמשך תמיד בידי המדריך.',
    ],
    importantToNoteEn: [
...
The reward: standing on the highest point in the Americas, with the Andes stretching endlessly in every direction.`,
    ...
    importantToNote: [
      'אקונקגואה (6962מ׳) היא הפסגה הגבוהה ביותר בעולם מחוץ לאסיה  -  נדרשים לפחות 3 שבועות בשטח עם רוטציות התאקלמות לגובה.',
      'היתר כניסה לפארק הלאומי ארגנטיני כלול בחבילה  -  עלות ההיתר עומדת על כ-900 דולר לעונה ומשולמת ישירות בארגנטינה.',
      'הקמפינג הוא על גבי הר  -  לינה באוהלים בגובה 5500מ׳, 6000מ׳ ו-6800מ׳. ציוד קמפינג חם מלא ושק שינה עד -25°C חובה.',
      'ישראלים לא צריכים ויזה לארגנטינה  -  כניסה חופשית עם דרכון בתוקף.',
      'אישור רפואי מורחב נדרש  -  ECG, בדיקת דם ואישור רופא לטיפוס ל-7000מ׳.',
      'נדרש ניסיון קודם בטיפוסים לגובה 5000מ׳ לפחות  -  אקונקגואה אינה מתאימה למתחילים.',
      'בטיחות לפני פסגה  -  אקונקגואה דורשת הכנה ארוכת טווח. רבים לא מגיעים לפסגה בגלל מזג אוויר, לא בגלל כושר.',
    ],
    importantToNoteEn: [
...
Join us for a once-in-a-lifetime adventure and take part in the fight against cancer!`,
    ...
    importantToNote: [
      'לנין פיק (7134מ׳) הוא פסגה של 7000 מטר  -  הטיפוס הרציני ביותר שלנו. נדרש ניסיון קודם בפסגות של לפחות 5500מ׳.',
      'הטיפוס כולל 3 רוטציות התאקלמות לפני יום הפסגה הסופי  -  סה"כ 21 ימים בשטח.',
      'הציוד הנדרש: קרמפונים, גרזן קרח, חבלים, ביגוד חורפי קיצוני עד -40°C. ציוד מלא מסופק על ידי HighAir.',
      'קירגיזסטן לא דורשת ויזה מאזרחי ישראל עד 30 יום  -  כניסה חופשית.',
      'אישור רפואי מורחב נדרש  -  ECG, בדיקת דם, אישור רופא לגובה 7000מ׳ וניסיון מוכח בטיפוסי גובה.',
      'ניסיון קודם בפסגות גבוהות הוא תנאי הכרחי  -  מומלץ ניסיון בקזבק, אלברוס או שווה ערך.',
      'בטיחות לפני פסגה  -  7000 מטר הוא שטח שולי. ההחלטה הסופית תמיד בידי המדריך.',
    ],
    importantToNoteEn: [
