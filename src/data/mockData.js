...
HighAir's Kilimanjaro expeditions have a 94% summit success rate - one of the highest in the industry - thanks to our experienced Israeli guides and careful acclimatization schedule.`,
    ...
    itineraryEn: [
      { day: 1, title: 'Tel Aviv – Addis Ababa – Kilimanjaro', desc: 'Depart from Ben Gurion Airport via Addis Ababa. Land at Kilimanjaro International Airport, group welcome, transfer to hotel in Moshi and shared dinner.' },
      { day: 2, title: 'Machame Gate – Machame Camp (2,835m)', desc: 'Drive to Machame Gate, registration and gear check. Begin trekking through dense tropical forest. 3-4 hours walking to the first camp.' },
      { day: 3, title: 'Machame Camp – Shira Cave Camp (3,750m)', desc: 'The forest gives way to heath zones. Climb through giant Protea and Senecio fields. Kibo Peak peeks above the clouds.' },
