...
This journey combines the contrast between desert heat and cold mountain winds - an unforgettable experience of nature in all its glory!`,
    ...
    itinerary: [
      { day: 1,  title: 'תל אביב - אדיס אבבה', desc: 'נצא בטיסה מתל אביב לאדיס אבבה. לאחר הנחיתה נגיע למלון בעיר הבירה, נבצע צ׳ק-אין וניקח זמן למנוחה והתארגנות. בערב ניפגש לארוחת ערב חגיגית לפתיחת הטיול, היכרות עם הצוות והקבוצה, ותדרוך קצר לקראת ההרפתקה שממתינה לנו.', accommodation: 'מלון Cot Hotel, אדיס אבבה' },
      { day: 2,  title: 'אדיס אבבה - גונדר', desc: 'נצא בטיסת פנים לגונדר, "עיר המלכים" של אתיופיה. עם ההגעה נצא לסיור: נבקר במתחם הארמונות המלכותיים מהמאה ה-17, נתרשם מכנסיית דברה ברהן סלעסי המפורסמת בציורי הקיר המרשימים שלה, ונלמד על ההיסטוריה המפוארת של בירתה הקדומה של אתיופיה.', accommodation: 'מלון AG Hotel Gondar, גונדר' },
      ...
      { day: 6,  title: 'צ׳נק (3620 מ׳) - ראס בוהאיט (4430 מ׳) - גונדר', desc: 'נצא בשעות הבוקר המוקדמות לטיפוס אל פסגת ראס בוהאיט (4,430 מ׳), הנקודה הגבוהה במסע והמרשימה ביותר בנופי השמורה. נחפש את הוואליה, היעל האתיופי הנדיר, את הזאב האתיופי, ועופות דורסים מרשימים המרחפים מעל הרכסים. לאחר הירידה חזרה למחנה, ניפרד מההרים ונסע לגונדר להתקלח, לנוח ולחגוג יחד את סיום שלב הטרק.', distance: '15 ק״מ', duration: 'כ-7-9 שעות', elevationGain: '810 מ׳', accommodation: 'מלון AG Hotel Gondar, גונדר' },
      { day: 7,  title: 'גונדר - אדיס אבבה - סמארה', desc: 'לאחר שינה טובה אחרי הטרק, נצא בבוקר בטיסת פנים מגונדר לסמארה, עם קונקשן קצר באדיס אבבה. לאחר הנחיתה נגיע למלון בעיירה, נבצע צ׳ק-אין וניקח זמן למנוחה והתארגנות. בערב ניפגש לארוחת ערב חגיגית ותדרוך קצר לקראת ימי מדבר הדנקיל שממתינים לנו.', accommodation: 'מלון Ruftana Hotel, סמארה' },
    ...
    itineraryEn: [
      ...
      { day: 6,  title: 'Chennek (3,620m) – Ras Bwahit (4,430m) – Gondar', desc: 'An early start for the summit push to Ras Bwahit (4,430m)  -  the highest point of the expedition and the most spectacular viewpoint in the reserve. We search for the Walia ibex, Ethiopian wolf and impressive raptors soaring above the ridges. After the descent we leave the mountains behind, drive back to Gondar and celebrate the end of the trekking leg together.', distance: '15 km', duration: '~7–9 hours', elevationGain: '810m', accommodation: 'AG Hotel Gondar, Gondar' },
      { day: 7,  title: 'Gondar – Addis Ababa – Samara', desc: 'After a well-earned rest following the trek, we take a domestic flight from Gondar to Samara with a short connection in Addis Ababa. After landing we check into the hotel, rest and get organised. In the evening we gather for dinner and receive a briefing for the Danakil Desert days ahead.', accommodation: 'Ruftana Hotel, Samara' },
