...
Glatt kosher meals throughout · Shabbat-aware scheduling · Hebrew + English guides · Cancer charity donation included`,
    ...
    notIncluded: [
      ...
      'חיסונים וייעוץ רפואי במרפאת מטיילים',
      'לילה נוסף במלון - 60$ לאדם בחדר זוגי (במידת הצורך)',
      'כל מה שלא צוין בחלק הכלול בטיפוס',
      'ספארי:',
      'טיפים למדריך ספארי - 45$ לאדם',
      'הוצאות אישיות במהלך השהות בספארי',
      'תוספות (לא חובה):',
      'חדר יחיד במלון בארושה - 120$ ללילה',
      'אוהל יחיד בטיפוס - 100$ לכל תקופת הטיפוס',
      'אוהל שלישייה (עמידה) בטיפוס - 150$ לכל תקופת הטיפוס',
      'חדר יחיד בלודג׳ בספארי - 200$ ללילה',
    ],
    notIncludedEn: [
      ...
      'Extra hotel night - $60 per person in double room (if needed)',
      'Anything not listed in the included section',
      'Safari:',
      'Tips for safari guide - $45 per person',
      'Personal expenses during the safari stay',
      'Optional extras:',
      'Single room at hotel in Arusha - $120/night',
      'Solo tent during climb - $100 for entire climb',
      'Triple standing tent during climb - $150 for entire climb',
      'Single room at safari lodge - $200/night',
    ],
