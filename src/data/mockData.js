...
HighAir's Kilimanjaro expeditions have a 94% summit success rate - one of the highest in the industry - thanks to our experienced Israeli guides and careful acclimatization schedule.`,
    ...
    itineraryEn: [
      ...
      { day: 2, title: 'Machame Gate (1,800m) – Machame Camp (2,835m)', desc: 'After breakfast at the hotel, gear up and meet the local crew for celebrations and dancing before departure. Drive about an hour to Machame Gate, the entrance to Kilimanjaro National Park at 1,800m. Enjoy lunch at the gate, then begin the ascent through spectacular rainforests. By mid-afternoon you\'ll arrive at Machame Camp, settle in, and share a group dinner together in the communal tent.', distance: '11 km', duration: '5–7 hours', elevationGain: '+1,035m gain', accommodation: 'Tents at Machame Camp' },
      ...
      { day: 4, title: 'Shira Cave Camp – Barranco Camp (3,900m)', desc: 'Critical acclimatization day: climb to Lava Tower at 4,630m then descend to Barranco Camp - "climb high, sleep low."' },
      { day: 5, title: 'Barranco Camp – Karanga Camp (3,995m)', desc: 'Physically challenging day opening with the Barranco Wall - a high rock face requiring hands and feet. Safe with the team.' },
      { day: 6, title: 'Karanga Camp – Barafu Camp (4,673m)', desc: 'Relatively long day through hills and valleys. Vegetation becomes sparse. Arrive at Barafu Camp - the night before the big push.' },
      { day: 7, title: 'Uhuru Peak (5,895m) – Mweka Camp (3,100m)', desc: 'Summit day! Depart at midnight - walk in darkness through intense cold. Climb via Stella Point (5,756m) to Uhuru Peak - the highest point in Africa.' },
      { day: 8, title: 'Mweka Camp – Mweka Gate (1,640m)', desc: 'Final descent through giant forests back to the park gate. Receive summit certificates and enjoy a celebration dinner with the Tanzanian team.' },
