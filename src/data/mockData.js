...
This journey combines the contrast between desert heat and cold mountain winds - an unforgettable experience of nature in all its glory!`,
    ...
    itinerary: [
      ...
      { day: 11, title: 'מקלה - אדיס אבבה - תל אביב', desc: 'נמריא ממקלה בטיסת פנים חזרה לאדיס אבבה. עם ההגעה נקדיש זמן לטיול קצר בעיר הבירה: ביקור בשוק מרקאטו הגדול, טקס קפה אתיופי מסורתי (בונה), וארוחת צהריים חגיגית. אחר הצהריים נסע לשדה התעופה לטיסת החזרה הביתה לישראל, מלאים בזכרונות ותמונות מהמסע המדהים.' },
    ],
    itineraryEn: [
